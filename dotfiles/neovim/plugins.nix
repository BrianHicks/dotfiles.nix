...
rec {
  ...
  airblade.vim-gitgutter = pkgs.vimUtils.buildVimPlugin {
    ...
    src = pkgs.fetchFromGitHub {
      owner = "airblade";
      repo = "vim-gitgutter";
      rev = "71bbe88525c0b36f4f3843a2a577442bbd7fd957";
      sha256 = "0rmdc0rgpmzjbij08aa102jg8shy4qbl1k5p1kw4xvn5l4faddvv";
    };
  };
  ...
  itchyny."lightline.vim" = pkgs.vimUtils.buildVimPlugin {
    ...
    src = pkgs.fetchFromGitHub {
      owner = "itchyny";
      repo = "lightline.vim";
      rev = "1f3da6f1bb78bfe0e6113d0812828329f3874b3e";
      sha256 = "0lwrb4x9sgwxdr1q4pwcc8fkq23ay4qyz6gb5scq2vivpzhj5y87";
    };
  };
  ...
  tpope.vim-fugitive = pkgs.vimUtils.buildVimPlugin {
    ...
    src = pkgs.fetchFromGitHub {
      owner = "tpope";
      repo = "vim-fugitive";
      rev = "f33a53bceb2b0461222cbe931adcaf9c66235535";
      sha256 = "00w1nkqh6iqcivasjqryca9k5w3ivlg1w05sd6gz0hcz9xg4amlm";
    };
  };
